import{s as T,a as v,g as B,o as oe,v as ne,E as se,x as U,y as W,z as ie,A as R,G as re,B as ce,n as z,d as P,b as I,j as F}from"./firebase-config-BRD6No76.js";import{e as le,P as de,i as ue,f as O,n as M}from"./user-schema-CuzC-Om2.js";import{d as pe}from"./ui-shell-CAP1PXY6.js";import{g as me,f as ge}from"./gmail-backend-qtwpdLGS.js";let w=null;function L(e){return String(e||"").replace(/&/g,"&amp;").replace(/"/g,"&quot;").replace(/</g,"&lt;")}function k(e,a={}){var p,h;const t=document.getElementById("user-profile");if(!t)return;if(!e){w==null||w.abort(),w=null,t.innerHTML="";return}const{isAdmin:o=!1,adminConsoleHref:i="./apps/admin-console/index.html",onOpenProfile:n}=a;w==null||w.abort(),w=new AbortController;const{signal:l}=w,c=e.displayName||e.email||"Usuario",d=o?`
